    ...
    <Panel className="p-6">
      ...
      <div className="grid grid-cols-3 gap-5">
        <div className="col-span-2 space-y-4">
          <div><label className="block font-mono text-[11px] text-foreground mb-1.5">Metric <span className="text-destructive">*</span></label><SelectBox value={form.metric} options={["Upload Bandwidth", "Download Bandwidth","Incoming Packet Drop Rate"]} onChange={v => setForm(f => ({ ...f, metric: v }))} /></div>
