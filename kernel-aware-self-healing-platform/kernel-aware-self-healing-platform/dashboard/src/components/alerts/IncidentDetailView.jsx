      ...
      <Panel>
        ...
        <div className="p-4 pt-0">
          ...
          <p className="text-sm text-muted-foreground text-pretty">
            ...
            in the application layer core. This is not a hardware failure but
            a recurring issue when processing large JSON payloads (&gt;100MB)
            via the Node.js event loop. The system observed similar behavior
            4 days ago.
          </p>
            ...
            <ul className="space-y-1.5 text-xs">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-foreground/80">
                  ...
                  library to version 2.4.0
                  (known fix for buffer leaks).
                </span>
