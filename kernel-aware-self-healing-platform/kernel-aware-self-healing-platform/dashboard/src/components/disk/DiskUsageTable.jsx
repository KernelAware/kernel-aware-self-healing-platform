    ...
    <Panel className="mt-4">
      ...
      <div className="p-2 space-y-10">
        <div className="overflow-hidden rounded-lg border border-border/60 bg-background shadow-sm">
          <iframe
            src="http://localhost:3000/d-solo/adqmnxx/disk-metrics?orgId=1&from=now-30m&to=now&timezone=browser&refresh=5s&showCategory=Panel%20options&panelId=panel-16" width="450" height="300" frameborder="0"
        ...
        <div className="mt-2 overflow-hidden rounded-lg border border-border/60 bg-background shadow-sm">
          <iframe
            src="http://localhost:3000/d-solo/adqmnxx/disk-metrics?orgId=1&from=now-30m&to=now&timezone=browser&refresh=5s&showCategory=Panel%20options&panelId=panel-15" width="450" height="1060" frameborder="0"
            className="w-full max-w-full"
